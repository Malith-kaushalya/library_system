    ...
    <body>
        ...
        <div class="container well well-sm" style="margin-left: 17%; width: 81%">
            ...
            <div class="form-group" style="margin-left: 70%;">
                <form action="view_books.php" method="POST" class="form-inline">
            ...
            <?php
               ...
               $result = $conn->query($sql); 
                    ...
                    echo "<tr class='info'><th>Item Name</th><th>Item Code</th><th>ISBN</th>"
                       . "<th>Category</th><th>quantity</th><th></th>";
                    echo "</thead>";
                    ...
                    include './book_search.php';
                     ...
                     while($row = $result->fetch_assoc()){
                             ...
                             ?>
                                <button class='btn btn-sm btn-info' type='submit' name="itemcode" value="<?php echo $row["b_item_code"] ?>">Edit &nbsp; <i class='fa fa-plus-square'></i></button>
                            <?php
                             echo "</form>";
                             echo "</td></tr>";
                             echo "</tr>"; 
                    ...
                    <ul class="pagination" style="margin-left: 5%">
                        <li><a href="view_books.php?page=<?php echo $i; ?>">&laquo;</a></li>
                         <li>
                         <?php
                      for ($i=1; $i<=$total_pages; $i++) {  // print links for all pages
                       echo "<a href='view_books.php?page=".$i."'";
                       if ($i==$page){  echo " class='curPage'";}
                       echo ">".$i."</a> "; 
                          }
                          ?>
                         </li>
                         <li><a href="view_books.php?page=<?php echo $i; ?>">&raquo;</a></li>
                    </ul>
        </div>
