...
if(isset($_POST["user_nic"])){
    ...
    $member_nic  = $_POST["user_nic"];
 
    //Get member details address from member table...
            ...
            <tr valign="top">
                <td width="100%">
                    <div class="well well-sm">
                        <h2 align="center">Send Message To <?php echo $member_name; ?></h2>
                        <hr><br>
                        <div class="form-group" style="margin-left: 5%;">
                            <form method="POST" action="send_mail.php" autocomplete="off" enctype="multipart/form-data">
